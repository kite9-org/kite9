...
public class Test52SideVertexPositioning extends AbstractFunctionalTest {


	@Test
	public void test_52_1_ContainerToContainerRight() throws IOException {
	...
	@Test
	public void test_52_2_ContainerToContainerDown() throws IOException {
		Glyph g1 = new Glyph("one", "","one", null, null);
		Glyph g2 = new Glyph("two", "","two ", null, null);
		Glyph g3 = new Glyph("three", "","three ", null, null);
		Glyph g4 = new Glyph("four", "","four ", null, null);
	...
	@Test
	public void test_52_3_ContainerToVertexRight() throws IOException {
	...
	@Test
	public void test_52_4_ContainerToVertexUp() throws IOException {
		Glyph g1 = new Glyph("g1", "", "g1", null, null);
		Glyph g2 = new Glyph("g2", "", "g2", null, null);
		Glyph g3 = new Glyph("g3", "", "g3", null, null);
		Glyph g4 = new Glyph("g4", "", "g4", null, null);
