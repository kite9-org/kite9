...
public class Test18DirectedPlanarization extends AbstractFunctionalTest {

	@Test
	public void test_18_1_AtoB() throws IOException {
	...
	@Test
	public void test_18_2_FourPointStar() throws IOException {
		Glyph a = new Glyph("", "A", null, null);
		Glyph b = new Glyph("", "B", null, null);
	...
	@Test
	public void test_18_3_VerticalBoxes() throws IOException {
	...
	@Test
	public void test_18_4_FourPointCross() throws IOException {
	...
	public void test_18_5_FourPointStarWithLoop() throws IOException {
	...
	@Test
	public void test_18_6_UndirectedMultiple() throws IOException {
	...
	@Test
	public void test_18_7_TrickyBuddyTop() throws IOException {
	...
	@Test
	public void test_18_8_TrickyBuddyLeft() throws IOException {
		Glyph flat = new Glyph("flat", "flat", null, null, null);
		Glyph buda = new Glyph("buda", "buda", null, null, null);
		Glyph budb = new Glyph("budb", "budb", null, null, null);
		Glyph buda2 = new Glyph("buda2", "buda2", null, null, null);
	...
	@Test
	public void test_18_9_FourPointStar4Middle() throws IOException {
	...
	@Test
	public void test_18_10_TrickyBuddyTopVariation() throws IOException {
		Glyph flat = new Glyph("flat", "flat", null, null, null);
		Glyph buda = new Glyph("buda", "buda", null, null, null);
		Glyph budb = new Glyph("budb", "budb", null, null, null);
		Glyph buda2 = new Glyph("buda2", "buda2", null, null, null);
	...
	@Test
	public void test_18_11_SimpleBuddyLeft() throws IOException {
		Glyph flat = new Glyph("flat", "flat", null, null, null);
		Glyph buda = new Glyph("buda", "buda", null, null, null);
		Glyph budb = new Glyph("budb", "budb", null, null, null);
		Glyph mid1 = new Glyph("mid1", "mid1", null, null, null);
	...
	@Test
	public void test_18_12_TrickySSingleDirectedMerge() throws IOException {
	...
	@Test
	public void test_18_13_TrickySSingleDirectedMergeUsingInternalGlyphs() throws IOException {
		Glyph a = new Glyph("a", "a", null, null, null);
		Glyph b = new Glyph("b", "b", null, null, null);

		Glyph c1 =  new Glyph("c1", "c1", null, null, null);
		Glyph c2 =  new Glyph("c2", "c2", null, null, null);
		Context c = new Context("c",createList((Contained) c1, c2), true, null, null);
	...
	@Test
	public void test_18_14_TrickyOverlappingProblem() throws IOException {
		...
		Context c = new Context("y1c",createList((Contained) c1, c2), true, null, null);
		
		Glyph d1 =  new Glyph("x1y2", "x1y2", null, null, null);
		Glyph d2 =  new Glyph("x3y2", "x3y2", null, null, null);
		Context d = new Context("y2c",createList((Contained) d1, d2), true, null, null);
	...
	@Test
	public void test_18_16_FlemishBond() throws IOException {
	...
	@Test
	public void test_18_17_UnavoidableCrossing() throws IOException {
		Glyph a = new Glyph("A", "", "A", null, null);
		Glyph b = new Glyph("B", "", "B", null, null);
		Glyph c = new Glyph("C", "", "C", null, null);
		Glyph d = new Glyph("D", "", "D", null, null);
	...
	@Test
	public void test_18_18_CuriousNeighbours1() throws IOException {
		Glyph a = new Glyph("A", "", "A", null, null);
		Glyph b = new Glyph("B", "", "B", null, null);
		Glyph c = new Glyph("C", "", "C", null, null);
		Glyph d = new Glyph("D", "", "D", null, null);
	...
	@Test
	public void test_18_19_CuriousNeighbours2() throws IOException {
		Glyph a = new Glyph("A", "", "A", null, null);
		Glyph b = new Glyph("B", "", "B", null, null);
		Glyph c = new Glyph("C", "", "C", null, null);
		Glyph d = new Glyph("D", "", "D", null, null);
	...
	@Test
	public void test_18_20_PavementContainers() throws IOException {
	...
	@Test
	public void test_18_21_BuddyOutsideContainer() throws IOException {
		Glyph a = new Glyph("A", "", "A", null, null);
		Glyph b = new Glyph("B", "", "B", null, null);
		Glyph c = new Glyph("C", "", "C", null, null);
...
//		new Link(b, c, null, null, null, null, Direction.RIGHT);
	...
	public void test_18_22_WrongVerticalOrdering() throws IOException {
		Glyph a = new Glyph("a", "", "a", null, null);
		Glyph b1 = new Glyph("b1", "", "b1", null, null);
		Glyph b2 = new Glyph("b2", "", "b2", null, null);
