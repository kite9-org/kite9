...
public class Test3MultiArrows extends AbstractFunctionalTest {
	...
	@Test
	public void test_3_1_3Glyphs1ArrowFinal() throws IOException {
	...
	@Test
	public void test_3_2_4Glyphs2Arrows() throws IOException {
		Glyph one = new Glyph("Stereo", "One", null, null);
		Glyph two = new Glyph("Stereo", "Two", null, null);
		Glyph three = new Glyph(null, "Three", null, null);
	...
	@Test
	public void test_3_3_4Glyphs3Arrows() throws IOException {
		Glyph one = new Glyph("Stereo", "One", null, null);
		Glyph two = new Glyph("Stereo", "Two", null, null);
		Glyph three = new Glyph(null, "Three", null, null);
		Glyph four = new Glyph(null, "Four", null, null);
	...
	@Test
	public void test_3_4_4Glyphs3PointArrows() throws IOException {
