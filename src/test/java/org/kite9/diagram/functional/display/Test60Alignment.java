...
public class Test60Alignment extends AbstractDisplayFunctionalTest {
	...
	public DiagramKite9XMLElement setUpDiagram1(Layout c4Layout, Layout c5Layout, VerticalAlignment gva, VerticalAlignment c4Align, HorizontalAlignment gha, Layout diagramLayout) {
	...
	public void test_60_1_ContentsAlignedTop() throws Exception {
		DiagramKite9XMLElement d = setUpDiagram1(Layout.DOWN, Layout.DOWN, VerticalAlignment.TOP, VerticalAlignment.CENTER, HorizontalAlignment.CENTER, Layout.RIGHT);
		renderDiagram(d);
	}
	
	@Test
	public void test_60_2_ContentsAlignedRight() throws Exception {
		DiagramKite9XMLElement d = setUpDiagram1(Layout.DOWN, Layout.DOWN, VerticalAlignment.CENTER, VerticalAlignment.CENTER, HorizontalAlignment.RIGHT, Layout.RIGHT);
		renderDiagram(d);
	}
	
	@Test
	public void test_60_3_ContentsAlignedDown() throws Exception {
		DiagramKite9XMLElement d = setUpDiagram1(Layout.DOWN, Layout.DOWN, VerticalAlignment.BOTTOM, VerticalAlignment.CENTER, HorizontalAlignment.LEFT, Layout.RIGHT);
		renderDiagram(d);
	}
