...
public class TestPositionRouter {
	...
	static class Printer { 
		...
		public void add(BoundsBasedPositionRoutingInfo bb, String c) {
			for (double x = bb.x.getDistanceMin(); x < bb.x.getDistanceMax(); x++) {
				for (double y = bb.y.getDistanceMin(); y < bb.y.getDistanceMax(); y++) {
