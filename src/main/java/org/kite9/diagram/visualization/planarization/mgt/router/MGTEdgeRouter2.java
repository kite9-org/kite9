 ...
 * 
 */
public class MGTEdgeRouter2 implements EdgeRouter, Logable {
 
	private RoutableReader rh;
	private ElementMapper em;

	public MGTEdgeRouter2(RoutableReader rh, ElementMapper em) {
		super();
		this.em = em;
		this.rh = rh;
	}
	...
	private Vertex createCrossingVertex(Edge e2, Edge e1) {
		// crossing vertices for container edges should have main underlying as their container
		EdgeCrossingVertex out = null;
		...
		if (e1Under instanceof Container) {
			out = new EdgeCrossingVertex("ecv" + vertexIntro++, e1Under);
			out.addUnderlying(e2Under);
		} else if (e2Under instanceof Container) {
			out = new EdgeCrossingVertex("ecv" + vertexIntro++, e2Under);
			out.addUnderlying(e1Under);
		}
