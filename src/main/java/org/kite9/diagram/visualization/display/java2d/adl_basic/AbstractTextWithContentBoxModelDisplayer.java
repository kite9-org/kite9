...
public abstract class AbstractTextWithContentBoxModelDisplayer extends AbstractTextBoxModelDisplayer {
	...
	public AbstractTextWithContentBoxModelDisplayer(CompleteDisplayer parent, Graphics2D g2, Stylesheet ss, boolean shadow, int xo, int yo) {
		super(parent, g2, ss, shadow, xo, yo);
	}

	public AbstractTextWithContentBoxModelDisplayer(Graphics2D g2, Stylesheet ss) {
		super(g2, ss);
	}
