...
public abstract class AbstractBoxModelDisplayer extends AbstractADLDisplayer {
	...
	public AbstractBoxModelDisplayer(CompleteDisplayer parent, Graphics2D g2, Stylesheet ss, boolean shadow, int xo, int yo) {
		super(parent, g2, ss, shadow, xo, yo);
	}

	public AbstractBoxModelDisplayer(Graphics2D g2, Stylesheet ss) {
		super(g2, ss);
	}
	...
	public void draw(DiagramElement element, RenderingInformation r) {
		...
		if ((fs != null) && (sh != null)) {
			...
			r2.setShapePath(getPathConverter().convert(s, xStart, yStart));
...
//			
	...
	public void paintBackground(BoxStyle bs, FlexibleShape fs, Graphics2D g2, double x1, double y1, double x2,
			double y2) {
