 ...
 *
 */
public class GriddedCompleteDisplayer implements RequiresGraphics2DCompleteDisplayer, Logable {

	RequiresGraphics2DCompleteDisplayer ded;
	double gridSize;
	...
	public GriddedCompleteDisplayer(RequiresGraphics2DCompleteDisplayer com, Stylesheet ss) {
		ded = com;
