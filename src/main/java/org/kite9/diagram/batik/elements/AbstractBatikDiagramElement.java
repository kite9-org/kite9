...
import org.kite9.framework.dom.processors.ValueReplacingProcessor;
import org.kite9.framework.dom.processors.XPathValueReplacer;
...
public abstract class AbstractBatikDiagramElement extends AbstractDOMDiagramElement implements HasSVGGraphics {
	 ...
	 */
	protected void preProcessSVGXPath(Element child) {
...
//		};
		...
		ValueReplacer vr = new XPathValueReplacer(theElement);
		
		new ValueReplacingProcessor(vr).processContents(child);
	}
