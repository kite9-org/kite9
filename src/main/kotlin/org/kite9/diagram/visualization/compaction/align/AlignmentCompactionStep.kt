...
import org.kite9.diagram.model.Container.getContents
import org.kite9.diagram.visualization.compaction.align.Aligner.willAlign
import org.kite9.diagram.visualization.compaction.align.Aligner.alignFor
import org.kite9.diagram.visualization.display.CompleteDisplayer
import org.kite9.diagram.visualization.compaction.align.Aligner
...
class AlignmentCompactionStep(cd: CompleteDisplayer?, vararg aligners: Aligner) : AbstractCompactionStep(
    ...
    fun alignOnAxis(c: Compaction?, contents: List<DiagramElement?>, a: Aligner, horizontal: Boolean, de: Container?) {
        val filtered: Set<Rectangular> = contents.stream()
