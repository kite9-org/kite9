...
class DistanceLayoutStrategy(rh: RoutableHandler2D) : AbstractTopDownLayoutStrategy(rh) {
    ...
    public override fun createPlacementApproach(
        ...
        return DistancePlacementApproach(log, gp, ld, gg, rh, setHoriz, setVert, natural)
    }
}