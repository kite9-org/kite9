...
class LongFraction(n: Long, d: Long): Comparable<LongFraction> {
     ...
     *
     * @param fraction
     * the [LongFraction] to add, must not be `null`.
     * @return a [LongFraction] instance with the resulting values.
     * @throws NullPointerException
     * if the [LongFraction] is `null`.
     */
     ...
     */
    override fun compareTo(o: LongFraction): Int {
        val nOd = numerator * o.denominator
        val dOn = denominator * o.numerator
     ...
     * `null`, not an instance of [LongFraction], or not
     ...
     *
     * @param fraction
     * the [LongFraction] to subtract, must not be
     * `null`.
     * @return a [LongFraction] instance with the resulting values
     * @throws NullPointerException
     * if the fraction is `null`.
