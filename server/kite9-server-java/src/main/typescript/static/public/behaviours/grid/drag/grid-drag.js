...
import { getOrdinal, getOrdinals, pushCells } from '../common-grid.js';
...
export function initCellDropLocatorCallback() {
 ...
 */
export function initCellDragLocator(selector = undefined) {
