...
export function initVoteContextMenuCallback(command, metadata, selector = null) {
    ...
    return function (event, contextMenu) {
        ...
        if (selectedElement) {
            if (canVote(selectedElement, true)) {
                contextMenu.addControl(event, "/public/behaviours/voting/vote/up.svg", "Vote Up", function () {
                    contextMenu.destroy();
                ...
                contextMenu.addControl(event, "/public/behaviours/voting/vote/down.svg", "Vote Down", function () {
                    contextMenu.destroy();
