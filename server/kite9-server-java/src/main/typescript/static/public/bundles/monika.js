 ...
 */
const _declaredHandlers = new WeakMap();
/**
 * Adds an event handler to the target with information so that it can be retrieved again.
 */
export function addNamedEventListener(et, type, name, eh, options) {
    // keep track of the listeners on the object 
    const listeners = _declaredHandlers.get(et) ?? {};
