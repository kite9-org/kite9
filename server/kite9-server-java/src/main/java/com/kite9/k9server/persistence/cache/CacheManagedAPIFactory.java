...
import com.kite9.k9server.persistence.queue.ChangeEventConsumerFactory;
...
import com.kite9.k9server.persistence.queue.CommandQueueModifiableDiagramAPI;
...
public abstract class CacheManagedAPIFactory implements SourceAPIFactory {
	...
	private Consumer<ChangeEvent> createConsumer(String path) {
