...
import com.kite9.k9server.persistence.cache.AbstractCachingModifiableDiagramAPI;
...
public class CommandQueueModifiableDiagramAPI extends AbstractCachingModifiableDiagramAPI {
	...
	public ADLBase getCurrentRevisionContent(Authentication a, HttpHeaders headers) throws Exception {
		if (getAuthenticatedRole(a) != com.kite9.k9server.adl.holder.meta.Role.NONE) {		
			if (localCache == null) {
	...
	@Override
	protected com.kite9.k9server.adl.holder.meta.Role getAuthenticatedRoleInner(Authentication a) {
