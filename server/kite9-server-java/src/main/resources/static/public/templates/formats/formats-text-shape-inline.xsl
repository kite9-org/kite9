<xsl:stylesheet xmlns="http://www.w3.org/2000/svg"
  ...
  <xsl:template name="formats-text-shape-inline" match="*[@format='text-shape-inline']">
    ...
    <xsl:param name="format">text-shape-inline</xsl:param>
    <xsl:param name="highlight">pulse</xsl:param>
    <xsl:param name="rounding">5pt</xsl:param>
    <xsl:param name="texture-shape">background</xsl:param>
