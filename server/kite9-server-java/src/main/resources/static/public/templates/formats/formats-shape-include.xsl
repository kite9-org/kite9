<xsl:stylesheet xmlns="http://www.w3.org/2000/svg"
  ...
  <xsl:template name="formats-shape" match="*[@k9-format='shape']">
    ...
    <xsl:param name="k9-ui">drag delete align connect insert autoconnect fill size align</xsl:param>
    ...
    <xsl:param name="decoration"><xsl:apply-templates mode="shape-decoration" select="." /></xsl:param>
