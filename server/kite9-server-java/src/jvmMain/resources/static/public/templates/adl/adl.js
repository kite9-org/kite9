...
export const command = new Command(), metadata = new Metadata(), transition = new Transition(), instrumentation = new Instrumentation(), dragger = new Dragger(), contextMenu = new ContextMenu(), containment = new Containment(), palette = new Palette("_palette", getDocumentParam('palettes')), paletteContextMenu = new ContextMenu(), overlay = new Overlay();
function initCommon() {
