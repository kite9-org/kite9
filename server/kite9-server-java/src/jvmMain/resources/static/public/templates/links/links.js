...
// Links
import { initLinkable, updateLink, initLinkerDropCallback, initAlignmentCollector } from '../../behaviours/links/linkable.js';
...
function initLinks() {
    if (metadata.isEditor()) {
        ...
        const alignmentIdentifier = (e) => e.getAttribute("k9-elem") == "align";
        ...
        dragger.moveWith(initAutoConnectMoveCallback(linker, paletteFinder, initAutoConnectTemplateSelector(getAlignTemplateUri, getLinkTemplateUri)));
        ...
        const portPosition = initStyleContextMenuCallback(command, overlay, portsPositionIcon, 'Port Position', initPortsPositionBuildControls(), initPortsSelector(), () => '', initPortsPositionChangeEvent);
