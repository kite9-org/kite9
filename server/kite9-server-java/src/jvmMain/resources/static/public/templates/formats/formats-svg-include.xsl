<xsl:stylesheet xmlns="http://www.w3.org/2000/svg"
  ...
  <xsl:template name="formats-container" match="*[@k9-format='svg']">
    ...
    <xsl:param name="k9-format">svg</xsl:param>
    ...
    <xsl:param name="decoration"><xsl:apply-templates mode="svg-decoration" select="." /></xsl:param>
  ...
  <xsl:template match="text()" mode="svg-decoration" />
