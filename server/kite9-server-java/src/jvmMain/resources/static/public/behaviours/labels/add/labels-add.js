...
export function initAddLabelContextMenuCallback(command, templateUri, selector = labelableSelector, action = createInsertLabelStep) {
    ...
    return function (event, contextMenu) {
        ...
        if (selectedElements.length > 0) {
            contextMenu.addControl(event, "/public/behaviours/labels/add/add.svg", "Add Label", function () {
                contextMenu.destroy();
