import { ok, text, hidden, formValues, formObject, select, div, fieldset, img, largeIcon, p } from '../../../bundles/form.js';
...
export function initNewDocumentContextMenuCallback(metadata, templateSource, selector = undefined) {
    ...
    function fullUri(target) {
        const currentUri = new URL(target, metadata.get("self"));
        return currentUri;
    }
    ...
    return function (event, cm) {
        ...
        if (e) {
            cm.addControl(event, "/public/behaviours/rest/NewDocument/add.svg", "New Document", function () {
                cm.clear();
                ...
                formArea.appendChild(fieldset('New Document', [
