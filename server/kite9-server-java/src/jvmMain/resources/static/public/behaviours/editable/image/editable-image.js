...
import { icon, text, p, inlineButtons, ok, cancel, formValues, img, fieldset, div } from '../../../bundles/form.js';
...
export function initEditableImageContextMenuCallback(command, metadata, selector = null) {
