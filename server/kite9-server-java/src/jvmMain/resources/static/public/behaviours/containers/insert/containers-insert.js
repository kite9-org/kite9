    ...
    return function (event, contextMenu) {
        ...
        function handleInsert(paletteElement, selectedElements) {
            ...
            Array.from(selectedElements)
                ...
                // update the adl
                return createInsertStep(e, paletteElement, newId, (before == undefined ? undefined : before.getAttribute("id")));
            })
        ...
        if (lastSelectedElement) {
            ...
            if (allowed) {
                contextMenu.addControl(event, "/public/behaviours/containers/insert/insert.svg", "Insert", function () {
                    contextMenu.destroy();
