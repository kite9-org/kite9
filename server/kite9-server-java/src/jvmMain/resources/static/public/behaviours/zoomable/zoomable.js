...
let running = false;
function smoothScroll(fx, fy, fm, fw, fh, tx, ty, tm, tw, th, startTime) {
    running = true;
...
function setScale(mag) {
    ...
    smoothScroll(window.scrollX, window.scrollY, magnification, mainWidthStart, mainHeightStart, newOffX, newOffY, mag, mainWidth, mainHeight, performance.now());
    magnification = mag;
}
 ...
 */
export const zoomableTransitionCallback = (newDocument, animationTimeline) => {
