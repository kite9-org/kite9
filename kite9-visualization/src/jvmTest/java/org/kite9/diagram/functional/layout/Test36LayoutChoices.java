...
public class Test36LayoutChoices extends AbstractLayoutFunctionalTest {
	...
	public static DiagramKite9XMLElement doNestedDirected(Layout cl1, Layout cl2, Layout dl, Direction going)
			throws Exception {
	...
	public static DiagramKite9XMLElement doSimpleComb(Layout cl, Layout dl, Direction going, boolean misorder)
			throws Exception {
		Glyph g0 = new Glyph("g0", "", "g0", null, null);
		Glyph g1 = new Glyph("g1", "", "g1", null, null);
		Glyph g2 = new Glyph("g2", "", "g2", null, null);
	...
	public static DiagramKite9XMLElement doArrowComb(Layout conl, Layout dl, Direction going) throws Exception {
		...
		Context con1 = new Context("con1", HelpMethods.listOf(g0, g1, g2, g3), true,
				new TextLabel("c1", Direction.RIGHT), conl);

		Context cona = new Context("cona", HelpMethods.listOf(a6, a5, a4, a3, a2, a1), true,
				new TextLabel("con a", Direction.RIGHT), conl);

		Context con2 = new Context("con2", HelpMethods.listOf(g4, g5, g6), true, new TextLabel("c2", Direction.RIGHT),
				conl);
	...
	public static DiagramKite9XMLElement doPyramid(Layout l, Layout dl, Direction going) throws Exception {
		...
		Context cona = new Context("coa4", HelpMethods.listOf(a6, a5, a4, a3, a7, a8, a2, a1), true,
				new TextLine("con a"), l);
		...
		DiagramKite9XMLElement d = new DiagramKite9XMLElement("D", HelpMethods.listOf(con1, con2, con3, cona), dl,
				null);
		return d;
	}
	...
	public void test_36_6_SimpleCombSlackAll() throws Exception {
		...
		// if ((assertDirection(d2, Direction.UP) || assertDirection(d2,
		// Direction.DOWN))) {
		// // ok
		// } else {
