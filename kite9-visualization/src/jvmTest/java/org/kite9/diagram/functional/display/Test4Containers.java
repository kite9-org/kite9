...
public class Test4Containers extends AbstractDisplayFunctionalTest {
	...
	public void test_4_4_LabelledContainers() throws Exception {
		...
		Context con1 = new Context("b1",
				createList(one,
						...
						new TextLabel("4. Bottom (Right)", Direction.DOWN, HorizontalAlignment.RIGHT)),
				true, null, null);
		...
		Context con3 = new Context("b3",
				createList(three, new TextLabel("9. Top (middle) \n1", Direction.UP),
						...
						new TextLabel("12. Left \n2 \n(middle)", Direction.LEFT)),
				true, null, null);

		TextLabel topl = new TextLabel("13. Top (middle) \n1", Direction.LEFT);
		topl.setAttribute("style",
				"--kite9-vertical-sizing: maximize; --kite9-horizontal-sizing: minimize; --kite9-direction: up;");
		...
		left.setAttribute("style",
				"--kite9-vertical-sizing: maximize; --kite9-horizontal-sizing: minimize; --kite9-direction: left;");
	...
	public void test_4_5_TurnsInsideContainers() throws Exception {
		...
		DiagramKite9XMLElement d = new DiagramKite9XMLElement("The Diagram", createList(con1, con2, three, four, five),
				null);
		renderDiagram(d);
	}
	...
	public void test_4_6_PushOutRectangularization() throws Exception {
		...
		con1.setAttribute("style",
				"--kite9-sizing: minimize; --kite9-horizontal-sizing: minimize; --kite9-direction: top;");
	...
	public void test_4_7_MinimumSizing() throws Exception {
		...
		Context con1 = new Context("b1", createList(one), true,
				new TextLabel("This is some really long and annoying label"), null);
