...
public class Test12LabelledArrowsEncapsulated extends AbstractDisplayFunctionalTest {
	...
	public void test_12_1_LabelledLeftRight() throws Exception {
		...
		LinkBody i1 = new LinkBody("i1", "i1asdas ");

		TextLabel fromLabel = new TextLabel("from (i1 end)", Direction.DOWN);
		fromLabel.setID("fromLabel");
		TextLabel toLabel = new TextLabel("to dsdsfds f ds f (b-end)", Direction.UP);
		toLabel.setID("toLabel");

		new Link(i1, a, null, null, null, null, Direction.LEFT);
		new Link(i1, b, null, fromLabel, LinkEndStyle.ARROW, toLabel, Direction.RIGHT);
	...
	public void test_12_3_SymbolLabels() throws Exception {
		...
		Glyph b = new Glyph("", "Something\nWicked", createList(new TextLine("some line of data")),
				createList(kh.createSymbol("terv", 'b', SymbolShape.HEXAGON)));
		...
		// TextLineWithSymbols clabel = new TextLineWithSymbols("Container Label",
		// createList(s1, s2));
		//
	...
	public void test_12_4_VeryLongLabels() throws Exception {
		...
		Context con = new Context("c1", createList(a, b, i1), true,
				new TextLabel("Container Label, oh the old container"), null);
	...
	public void test_12_6_GlyphMultipleLabels() throws Exception {
		...
		new Link(i1, a, null, null, null, new TextLabel("from the wild side\ngoing east on the highway\nwith a frog"),
				Direction.UP);
		new Link(i2, a, null, null, LinkEndStyle.ARROW, null /* new LabelTextLine("to the safe side A") */,
				Direction.UP);
		new Link(i3, a, null, null, LinkEndStyle.ARROW, null /* new LabelTextLine("to the safe side B") */,
				Direction.UP);
