...
public class Test35ContainerAndVertexLinking extends AbstractLayoutFunctionalTest {
	...
	public void test_35_2_ForceContentLink() throws Exception {
		...
		DiagramKite9XMLElement d = new DiagramKite9XMLElement("D", createList(g0, con1, g4, g5, g6), Layout.RIGHT,
				null);
		renderDiagram(d);
	}
	...
	public void test_35_3_NestedContextLink() throws Exception {
		...
		Context con2 = new Context("outside", HelpMethods.listOf(con1, g4, g5), true, new TextLine("outside"),
				Layout.DOWN);
	...
	public void test_35_4_TwoContextLink() throws Exception {
		...
		DiagramKite9XMLElement d = new DiagramKite9XMLElement("D", createList(g0, con1, con2, g7), Layout.HORIZONTAL,
				null);
		renderDiagram(d);
	}
	...
	public void test_35_7_OctopusContext() throws Exception {
		...
		DiagramKite9XMLElement d = new DiagramKite9XMLElement("D",
				createList(con1, g0, g1, g2, g3, g4, g5, g6, g7, g8, g9, g10, g11), null);
		renderDiagram(d);
	}
	...
	public void test_35_9_WithoutLinks() throws Exception {
		Glyph g0 = new Glyph("g0", "", "g0", null, null);
		Glyph g2 = new Glyph("g2", "", "g2", null, null);
		Context con1 = new Context("inside", HelpMethods.listOf(g0, g2), true, null, null);
