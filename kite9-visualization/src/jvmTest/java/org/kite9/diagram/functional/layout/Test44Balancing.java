...
public class Test44Balancing extends AbstractLayoutFunctionalTest {
	...
	public void test_44_1_SingleGlyph() throws Exception {
		...
		DiagramKite9XMLElement d = new DiagramKite9XMLElement("d", HelpMethods.listOf(a),
				new Key("this is a very long piece of text", "", null));
		renderDiagram(d);
	}
	...
	public void test_44_2_UnjoinedGlyphs() throws Exception {
		...
		DiagramKite9XMLElement d = new DiagramKite9XMLElement("d", HelpMethods.listOf(a, b),
				new Key("this is a very long piece of text", "", null));
	...
	public void test_44_4_SimpleV() throws Exception {
		...
		DiagramKite9XMLElement d = new DiagramKite9XMLElement("d", HelpMethods.listOf(a, b, c),
				new Key("this is a very long piece of text", "", null));
		renderDiagram(d);
	}
