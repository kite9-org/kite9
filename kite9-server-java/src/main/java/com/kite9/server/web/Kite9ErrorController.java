...
public class Kite9ErrorController implements ErrorController {
	...
	public static final String HIGHLIGHTER = "<link rel=\"stylesheet\"  href=\"/webjars/highlightjs/9.6.0/styles/github.css\">\n"
			+
	...
	private void processException(StringBuilder sb, Throwable e, int level) {
		...
		if (e != null) {
			sb.append(
					"<div class=\"card\" style=\"margin-bottom: 30pt;\"><div class=\"card-body\"><h4 class=\"card-title\">");
			sb.append("(" + level + ") ");
