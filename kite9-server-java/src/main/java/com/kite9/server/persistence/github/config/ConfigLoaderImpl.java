...
public class ConfigLoaderImpl implements ConfigLoader {
	...
	@Override
	public Config loadConfig(Authentication authentication, String owner, String reponame, String ref)
			throws IOException {
		try {
			K9URI sourceUri = URIRewriter
					.resolve("/github/" + owner + "/" + reponame + "/" + KITE9_CONFIG_FILE + "?v=" + ref);
	...
	public Config loadConfig(String yamlString) {
		...
		Yaml yaml = new Yaml(new Constructor(Config.class, loaderOptions), representer);
