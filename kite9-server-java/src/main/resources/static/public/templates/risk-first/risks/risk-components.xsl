<xsl:stylesheet xmlns="http://www.w3.org/2000/svg"
  ...
  <xsl:template match="adl:risk[@class='hidden']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/hidden_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='invisibility']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/invisibility_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='feature']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/feature_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='market']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/feature_market_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='communication']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/communication_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='coordination']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/coordination_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='complexity']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/complexity_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='boundary']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/boundary_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='agency']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/agency_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='channel']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/channel_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='protocol']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/protocol_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='learning-curve']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/learning_curve_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='message']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/message_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='internal-model']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/internal_model_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='implementation']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/feature_implementation_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='feature-drift']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/feature_drift_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='feature-access']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/feature_access_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='regression']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/feature_regression_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='conceptual-integrity']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/conceptual_integrity_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='codebase']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/codebase_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='dependency']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/dependency_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='dead-end']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/dead_end_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='reliability']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/dependency_reliability_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='scarcity']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/dependency_scarcity_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='operational']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/operational_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='schedule']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/dependency_schedule_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='opportunity']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/dependency_opportunity_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='deadline']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/dependency_deadline_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='funding']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/dependency_funding_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='red-queen']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/dependency_red_queen_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='staff']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/staff_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='process']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/dependency_process_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='map-and-territory']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/map_and_territory_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='software-dependency']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/dependency_software_risk_v2.svg</xsl:with-param>
  ...
  <xsl:template match="adl:risk[@class='security']">
    <xsl:call-template name="risks-fixed">
      ...
      <xsl:with-param name="image">/public/templates/risk-first/redesign/risks/security_risk_v2.svg</xsl:with-param>
