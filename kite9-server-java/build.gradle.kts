...
dependencies {
    ...
    implementation(project(":kite9-pipeline-common"))
    ...
    implementation("org.webjars.npm:codemirror:5.58.3")
    implementation("org.webjars:highlightjs:9.6.0")
    implementation("org.webjars.npm:hint.css:2.3.2")
    implementation("org.webjars.npm:kotlin:1.4.30")
