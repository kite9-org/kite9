<xsl:stylesheet 
  ...
  <xsl:template match="/" mode="diagram-defs">
   ...
   <xsl:template match="/" mode="diagram-script">
  	 import '/github/kite9-org/kite9/templates/admin/admin.js?v=v0.8'
   </xsl:template>
   
   <xsl:template match="/" mode="diagram-element-css">
     <xsl:call-template name="adl-diagram-element-css" />
     <adl:css>@import url('/github/kite9-org/kite9/templates/admin/admin-elements.css?v=v0.8');</adl:css>     
   </xsl:template>
   ...
   <xsl:template match="/" mode="diagram-texture-css">
     <adl:css>@import url('/github/kite9-org/kite9/templates/admin/admin-textures.css?v=v0.8');</adl:css>
   </xsl:template>
