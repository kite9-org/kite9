...
import { Property } from '/github/kite9-org/kite9/client/classes/property/property.js?v=v0.4'
...
// selectable
import { initDeleteContextMenuCallback } from '/github/kite9-org/kite9/behaviours/selectable/delete/selectable-delete.js?v=v0.4'
import { initReplaceContextMenuCallback, initReplacePaletteCallback } from '/github/kite9-org/kite9/behaviours/selectable/replace/selectable-replace.js?v=v0.4'
import { initXCPContextMenuCallback } from '/github/kite9-org/kite9/behaviours/selectable/xcp/xcp.js?v=v0.4'
import { initSelectable } from '/github/kite9-org/kite9/behaviours/selectable/selectable.js?v=v0.4'

// indication
import { initToggleInstrumentationCallback } from '/github/kite9-org/kite9/behaviours/indication/toggle/toggle.js?v=v0.4'

// navigation
import { closeMetadataCallback, initCloseInstrumentationCallback } from "/github/kite9-org/kite9/behaviours/navigable/close/close.js?v=v0.4";

// undo, redo, revisions
import { initUndoableInstrumentationCallback, initUndoableCommandCallback } from "/github/kite9-org/kite9/behaviours/revisioned/undoable.js?v=v0.4";

// editing
import { initXMLContextMenuCallback } from '/github/kite9-org/kite9/behaviours/editable/xml/editable-xml.js?v=v0.4'
import { initEditContextMenuCallback } from '/github/kite9-org/kite9/behaviours/editable/text/editable-text.js?v=v0.4'
import { initEditableImageContextMenuCallback } from '/github/kite9-org/kite9/behaviours/editable/image/editable-image.js?v=v0.4'
 ...
 */
import { command, metadata, transition, instrumentation, dragger, contextMenu, palette } from '/github/kite9-org/kite9/templates/adl/adl.js?v=v0.4'
