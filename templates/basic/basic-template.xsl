<xsl:stylesheet xmlns="http://www.w3.org/2000/svg"
  ...
  <xsl:template match="/" mode="diagram-element-css">
    ...
    <adl:css>@import url('/github/kite9-org/kite9/templates/basic/basic-elements.css?v=v0.14');</adl:css>
  </xsl:template>
  
  <xsl:template match="/" mode="diagram-texture-css">
    <adl:css>@import url('/github/kite9-org/kite9/templates/basic/basic-textures.css?v=v0.14');</adl:css>
  </xsl:template>
  
  <xsl:template match="/" mode="diagram-script">
    import '/github/kite9-org/kite9/templates/basic/basic.js?v=v0.14'
  </xsl:template>
  ...
  <xsl:template match="/" mode="diagram-palettes">
    <adl:palette contains="connected" url="/github/kite9-org/kite9/templates/basic/palette.adl?v=v0.14" />
