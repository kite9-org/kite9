...
public class ADLExtensibleDOMImplementation extends CachingSVGDOMImplementation {
	...
	public ADLExtensibleDOMImplementation(Cache cache) {
		...
		// LABELS
		registerCustomCSSValueManager(new EnumManager(CSSConstants.LABEL_PLACEMENT, LabelPlacement.class, null, false));
		...
		// TEXT BOUNDS
		registerCustomCSSShorthandManager(new SizeShorthandManager(CSSConstants.TEXT_BOUNDS_WIDTH, CSSConstants.TEXT_BOUNDS_HEIGHT, CSSConstants.TEXT_BOUNDS_SIZE));
